...
const nav = () => {
  return (
    <>
    <nav className="flex justify-between font-mono rounded-bl-2xl rounded-br-2xl mx-10 md:mx-20 lg:mx-30 xl:mx-40 px-16 items-center h-16 bg-emerald-200 shadow-2xl relative" role="navigation">
      <div className="w-3/6">
