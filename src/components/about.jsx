    ...
    <section id='about' className='relative w-full min-h-screen bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${BgAbout})` }}>
      <div className="flex items-center absolute top-0 left-0 w-full h-full inset-0 bg-[#333B50]/70 z-10">
        <motion.div
          ...
          className='container flex flex-col mx-auto items-center justify-center bg-[#333B50] w-[380px] md:w-[60%] lg:w-[70%] xl:w-[50%] shadow-2xl shadow-[#333B50] rounded-2xl p-6 md:px-12 lg:px-24'
        >
          <div>
            <img  src={logo} alt="logo"/>
          </div>
          <div className='text-white font-[Poppins] text-[14px] md:text-[14px] lg:text-[18px] text-justify py-8 lg:py-16'>
