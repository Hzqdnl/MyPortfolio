    ...
    <section id='about' className='relative w-full h-screen bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${BgAbout})` }}>
      <div className="absolute top-0 left-0 w-full h-full inset-0 bg-[#333B50]/70 z-10">
        <motion.div
          ...
          className='container h-[80vh] my-[65px] md:my-[80px] flex flex-col mx-auto items-center justify-center bg-[#333B50] w-[380px] md:w-[50%] shadow-2xl shadow-[#333B50] rounded-2xl p-6 md:px-24'
        >
          <div>
          ...
          <div className='cursor-pointer bg-transparent text-[14px] md:text-[16px] font-[Poppins] border-2 border-[#00D646] text-white uppercase py-1 px-2 md:py-2 md:px-6 transition-all duration-200 hover:bg-[#00D646] hover:text-[#333B50] hover:border-[#333B50]'>
            <a href="#">
              Download Resume
            </a>
          </div>
